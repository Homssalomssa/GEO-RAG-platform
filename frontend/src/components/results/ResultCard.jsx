...
export default function ResultCard({ result, index }) {
  const { fileName, answer, visionFeatures, retrievedContext, gisData, timing } = result

  // Generate hero image placeholder (in real app, would be the actual satellite image)
  ...
  return (
    <div className="bg-surface-container-lowest rounded-xl p-0 overflow-hidden transition-all hover:shadow-lg flex flex-col">
      ...
      <div className="relative h-48 w-full overflow-hidden">
        <img className="w-full h-full object-cover" src={imageUrl} alt={fileName} />
